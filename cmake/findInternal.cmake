...
IF(ALPAKA_ROOT)
    ...
    IF(NOT TARGET "alpaka")
        ...
        append_recursive_files_add_to_src_group(${ALPAKA_SUFFIXED_INCLUDE_DIR} ${alpaka_INCLUDE_DIR} "hpp" ALPAKA_HEADER_FILES_ALL)

        # Add all the source files in all recursive subdirectories and group them accordingly.
        append_recursive_files_add_to_src_group(${ALPAKA_SUFFIXED_INCLUDE_DIR} ${alpaka_INCLUDE_DIR} "cpp" ALPAKA_SOURCE_FILES_ALL)
